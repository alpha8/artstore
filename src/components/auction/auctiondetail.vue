  ...
  export default {
    ...
    methods: {
      ...
      wxReady() {
        ...
        let shareData = {
          title: `[${api.CONFIG.NICKNAME || '一虎一席'}.拍卖.${this.auction.startPrice}元] ` + reduceGoodsName(this.auction.name),
          desc: `起拍价：¥${this.auction.startPrice}.「${api.CONFIG.APPNAME || '一虎一席茶生活美学商城'}」精品.【一站式优品商城，品味脱凡】`,
          link: redirect,
          imgUrl: icon
        };
        wx.ready(function() {
